...
<head>
    ...
    <!-- Document Title -->
    <title>Internet for Remote Work</title>
...
<body>
    ...
    <section class="page-not-found pt-120">
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="not-found">
                        <h2 data-animate="fadeInUp" data-delay=".1">Coming soon</h2>
                        <p data-animate="fadeInUp" data-delay=".3">Service not yet available. <br>Ensure to subscribe to our newsletter so we can inform you when it's on.</p>
                    </div>
                </div>
            </div>
        </div>
